...
import com.example.app.micro.productservice.infrastructure.persistence.mapper.ProductPersistenceMapper;
...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    public List<Product> findByName(String name) {
        ...
        return mapper.toDomainList(jpaProductRepository.findByName(name));
    }
}
